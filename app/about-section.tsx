        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-6 scroll-animate-left">
            <div className="prose prose-lg text-gray-600">
              <h3 className="text-2xl font-bold text-gray-800 mb-4">Premier IT Services & Data Center Solutions in Pakistan</h3>
              ...
              <p className="text-lg leading-relaxed text-gray-600 mb-6 scroll-animate stagger-1">
                ...
                <strong className="text-stg-orange">Gilgit-Baltistan, Pakistan</strong>. We specialize in delivering comprehensive IT services, data
                center establishment, and computer electronics at competitive pricing with exceptional service and expert guidance.
              </p>
              ...
              <p className="leading-relaxed text-gray-600 mb-6 scroll-animate stagger-2">
                ...
                <strong className="text-stg-orange">custom build systems</strong> for Government, semi-Government, and Private organizations across
                Pakistan. Our services include monthly and annual maintenance contracts for laptops, desktops, servers, tablets, phones, and GPS
                consoles throughout <strong className="text-stg-orange">Gilgit-Baltistan</strong>.
              </p>

              <h4 className="text-xl font-semibold text-gray-800 mb-3">Data Center Establishment & Server Customization Expertise</h4>
              <p className="leading-relaxed text-gray-600 mb-6 scroll-animate stagger-3">
                ...
                <strong className="text-stg-orange">Server customization</strong> with professional installation and deployment services. STG has
                successfully established <strong className="text-stg-orange">4 tier data centers</strong> across Gilgit-Baltistan, helping customers
                optimize their network & systems while rapidly deploying new technologies.
              </p>
              ...
              <p className="leading-relaxed text-gray-600 mb-6 scroll-animate stagger-4">
                Located in the center of <strong className="text-stg-orange">Gilgit, Gilgit-Baltistan</strong>, our strategic position provides easy
                accessibility to the local community and regional businesses. We offer the latest technology computer hardware, custom-built computer
                systems, comprehensive computer services, equipment rentals, and professional networking services across{" "}
              ...
              <p className="leading-relaxed text-gray-600 scroll-animate stagger-5">
                We are dedicated to providing consistently high client satisfaction through excellent service, carrying items not locally available,
                and maintaining a professional atmosphere at competitive prices. Our work environment emphasizes respect for our clients and community
                throughout <strong className="text-stg-orange">Gilgit-Baltistan, Pakistan</strong>.
              </p>
            </div>
