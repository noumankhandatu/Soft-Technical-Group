          ...
          <div className="space-y-6 scroll-animate-left">
            <div className="prose prose-lg text-gray-600">
              <p className="text-lg leading-relaxed text-gray-600 mb-6 scroll-animate stagger-1">
                Soft Technical Group established during the year <strong className="text-stg-orange">2006</strong>,
                aiming to provide IT based services and to deliver a vast selection of computer electronics at
                competitive pricing accompanied by the best service and the right advice.
              </p>

              <p className="leading-relaxed text-gray-600 mb-6 scroll-animate stagger-2">
                STG provides access to OEM products and custom build systems. We also offer service and repair work to
                the Government, semi Government and Private organizations on monthly and annual basis. These includes
                but are not limited to laptops, desktops, Servers, Tablets and phones etc. We are also capable of
                serving GPS consoles.
              </p>
              ...
              <p className="leading-relaxed text-gray-600 mb-6 scroll-animate stagger-3">
                ...
                <strong className="text-stg-orange">Server customization</strong>, its installation and deployment. STG
                aims to help customers optimize their network & Systems, rapidly deploy new technologies and maintain
                maximum productivity.
              </p>

              <p className="leading-relaxed text-gray-600 mb-6 scroll-animate stagger-4">
                We are located in the center of <strong className="text-stg-orange">Gilgit of Gilgit-Baltistan</strong>.
                Our location is a major asset, as it is accessible to the local community as well as tourism to the
                Area. We offer a wide selection of latest-technology computer hardware, custom-built computer systems,
                computer service, and computer rentals by the hour, and networking services.
              </p>

              <p className="leading-relaxed text-gray-600 scroll-animate stagger-5">
                We are dedicated to providing consistently high client satisfaction by rendering excellent service,
                carrying items that are not locally available, and furnishing a warm, pleasant atmosphere at a
                competitive price. Our work environment will be one of respect for our clients and our community.
              </p>
            </div>
