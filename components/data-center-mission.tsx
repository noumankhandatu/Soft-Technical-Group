        ...
        <div className="max-w-5xl mx-auto">
          <div className="bg-gradient-to-br from-orange-50 to-white p-12 rounded-2xl shadow-lg animate-fade-in-up animation-delay-400">
            <p className="text-lg leading-relaxed text-gray-700 text-center">
              To provide the Area with <strong className="text-stg-orange">quality brand-name products</strong>, computer and networking solutions,{" "}
              <strong className="text-stg-orange">reliable and professional technical support</strong>, and{" "}
              <strong className="text-stg-orange">unparalleled customer service</strong> through the application of the principles, and to earn a fair
              profit for our employee-owners and stakeholders by embracing sound,{" "}
