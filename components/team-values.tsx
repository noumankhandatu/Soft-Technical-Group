      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {values.map((value, index) => (
            <div key={index} className="text-center group animate-fade-in-up" style={{ animationDelay: `${index * 150}ms` }}>
              ...
              <h3 className="text-xl font-bold text-gray-800 mb-4 group-hover:text-stg-orange transition-colors duration-300">{value.title}</h3>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          {stats.map((stat, index) => (
            <div key={index} className="text-center animate-fade-in-up" style={{ animationDelay: `${(index + 6) * 150}ms` }}>
        ...
        <div className="bg-gradient-to-r from-stg-orange to-orange-600 rounded-2xl p-12 text-center text-white animate-fade-in-up animation-delay-1000">
          ...
          <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
            Let our experienced professionals help you achieve your technology goals. From planning to implementation, we're here to ensure your
            success.
          </p>
        ...
        {/* <div className="mt-16 bg-gray-50 p-12 rounded-2xl animate-fade-in-up animation-delay-1200">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 mb-8">
              We're always looking for talented individuals who share our passion for technology and commitment to excellence. If you're ready to make
              an impact and grow your career with a dynamic team, we'd love to hear from you.
            </p>
